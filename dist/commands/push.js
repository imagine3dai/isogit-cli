...
export function push(program) {
    ...
    program
        ...
        .action(function (remote, branch, options) { return __awaiter(_this, void 0, void 0, function () {
        var dir, currentBranch, tags, _i, tags_1, tag, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    logger.info("Pushing to ".concat(remote, "/").concat(branch || currentBranch, "..."));
                ...
                case 3:
                    _a.sent();
                    if (!options.tags) return [3 /*break*/, 8];
                ...
                case 9:
                    error_1 = _a.sent();
                    logger.error('Push failed:', error_1);
                    return [3 /*break*/, 10];
