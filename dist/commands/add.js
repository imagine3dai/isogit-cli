...
export function add(program) {
    ...
    program
        ...
        var dir, status_2, _i, status_1, filepath, _a, paths_1, filepath, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    _b.label = 8;
                case 8:
                    if (!(_a < paths_1.length)) return [3 /*break*/, 11];
                    filepath = paths_1[_a];
                    return [4 /*yield*/, git.add({ fs: fs, dir: dir, filepath: filepath })];
                case 9:
                    _b.sent();
                    logger.success("Added ".concat(filepath, " to the index"));
                    _b.label = 10;
                case 10:
                    _a++;
                    return [3 /*break*/, 8];
                ...
                case 12:
                    error_1 = _b.sent();
                    logger.error('Failed to add files:', error_1);
                    return [3 /*break*/, 13];
