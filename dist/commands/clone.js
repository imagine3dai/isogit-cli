...
export function clone(program) {
    ...
    program
        ...
        .action(function (url, directory, options) { return __awaiter(_this, void 0, void 0, function () {
        var dir, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    dir = directory || path.basename(url, '.git');
                    logger.info("Cloning into '".concat(dir, "'..."));
                ...
                case 2:
                    error_1 = _a.sent();
                    logger.error('Clone failed:', error_1);
                    return [3 /*break*/, 3];
